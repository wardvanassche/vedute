    ...
    <body>
        <div class="registration-form">
            <form action="" method="post">
                ...
                <div class="form-group">
                    Auteur
                    <input type="text" class="form-control item" id="news_author" value="<?php echo $author; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" name="update" value="submit" class="btn btn-block create-account">Aanmaken</button>
                </div>
            </form>
        </div>
    </body>
